...
#define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_CUSTOM_multinexus_backlight   // Sets the default mode, if none has been set
#define RGB_MATRIX_STARTUP_HUE 118
#define RGB_MATRIX_STARTUP_SAT 255
#define RGB_MATRIX_STARTUP_SPD 125
