  ...
  switch(id) {
    case LONG_DASH: {
        if (record->event.pressed) {
            send_unicode_string("—"); // REPLACE with what you want your macro to be
            return false;
        }
    }
    case MID_DASH: {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        ...
        KC_NLCK, _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,    _______, M(LONG_DASH), M(MID_DASH), _______,   _______, _______, _______, \
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [1] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, CORAL, \
    ...
    [2] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        GREEN, _______, _______, _______, _______, _______, _______, MAGENT,   MAGENT,   MAGENT,    _______, GREEN, GREEN, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, MAGENT,   MAGENT,   MAGENT,   _______, _______, _______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, MAGENT,   MAGENT,   MAGENT,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, MAGENT,   MAGENT,   MAGENT,   GREEN, _______, _______,                              _______, \
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,            _______, _______, _______ \
    },
};
